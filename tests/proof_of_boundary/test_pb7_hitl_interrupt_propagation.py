...
#
# Two test cases (proof-of-boundary PB-7 — HITL interrupt propagation):
#
...
#   HITL Compliance (D6 pattern, hitl_allowed guard)
#   the review criterion requiring an explicit hitl_allowed guard
...
def test_pb7_hitl_allowed_false_skips_interrupt() -> None:
    ...
    Covers HITL Compliance + the hitl_allowed-guard review criterion:
